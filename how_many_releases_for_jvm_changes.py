...
def list_of_diffoscope_files_with_jvm_changes():
    with open('gradle_diffoscope_files_with_jvm.txt', 'r') as f:
...
def main():
    ...
    for project in maven_projects:
        ...
        for release in maven_releases:
            unreproducible_artifacts = release["unreproducibleArtifacts"]
    ...
    json.dump(maven_projects_with_only_jvm, open("gradle_projects_with_jvm_changes.json", "w"), indent=2)
